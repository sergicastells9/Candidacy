...
% need to clarify all of this part
% identification of photon (candidate of photon. could be an electron? fake photons? need to explain to variables!!!)
...
% mimicking cuts, additional cuts and selections on the pseudoscalars and the four photon object, a Boosted Decision Tree (BDT) model to discriminate signal/background, and a categorization procedure based on BDT score.

...
\begin{figure}[t]
   ...
   \begin{minipage}{0.48\textwidth}
     ...
     \caption{The MVA ID for $\gamma_4$, calculated by the $h\rightarrow \gamma\gamma$ group, is the strongest discriminating variable for the event selection BDT. Signal MC for four nominal pseudoscalar mass points, event mixed background, and data are shown with selections applied.}
